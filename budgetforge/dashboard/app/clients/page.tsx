...
function PlanCountCard({ plan, count }: { plan: string; count: number }) {
  ...
  return (
    ...
    >
      ...
      <div
        className="font-heading font-800 text-4xl tracking-tight"
        style={{ color }}
      >
        {count}
      </div>
...
export default function ClientsPage() {
  ...
  const signupTotal =
    stats?.signups_last_30_days.reduce((s, d) => s + d.count, 0) ?? 0;
      ...
      <div className="p-6 max-w-6xl">
        ...
        >
          ...
          <p className="text-[--muted-fg] text-sm">
            Business overview — signups, plans, revenue
          </p>
        </motion.div>
        ...
        {loading ? (
          ...
          <div className="card-base p-10 text-center text-[--muted-fg] text-sm">
          ...
          <>
            ...
            >
              ...
              <StatCard
                icon={CreditCard}
                label="Total Spend"
                value={`$${stats.total_spend_usd.toFixed(2)}`}
                accent="#a855f7"
            ...
            >
              {(["free", "pro", "agency"] as const).map((plan) => (
                <PlanCountCard
                  key={plan}
                  plan={plan}
                  count={stats.clients_by_plan[plan] ?? 0}
                />
              ))}
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              >
                ...
                {planEntries.length === 0 ? (
                  <p className="text-xs text-[--muted-fg] py-8 text-center">
                    No clients yet
                  </p>
                ) : (
                  <ResponsiveContainer width="100%" height={140}>
                    <BarChart
                      data={planEntries.map(([plan, count]) => ({
                        plan,
                        count,
                      }))}
                      margin={{ top: 4, right: 4, left: -20, bottom: 0 }}
              ...
              >
                ...
                <div className="flex flex-col gap-3">
                    ...
                    return (
                      ...
                      >
                        ...
                        <span
                          ...
                          style={{
                            color: mrr > 0 ? "#f59e0b" : "var(--muted-fg)",
                          }}
                        >
                          {mrr > 0 ? `$${mrr}/mo` : "—"}
                        </span>
                  ...
                  <div className="border-t border-[--border] mt-1 pt-3 flex items-center justify-between">
                    ...
                    <span className="font-mono font-700 text-[--amber]">
                      ${stats.mrr_usd}/mo
                    </span>
                  </div>
                </div>
