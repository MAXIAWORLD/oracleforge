...
export default function DemoLayout({
  ...
  return (
    ...
    >
      {/* Demo banner */}
      <div
        className="w-full py-2 px-4 text-center text-sm font-semibold flex items-center justify-center gap-3 shrink-0"
      ...
      <div className="flex flex-1 min-h-0">
        ...
        >
          ...
          <nav className="flex flex-col gap-1 p-3 flex-1">
            <p
              className="text-[10px] font-semibold uppercase tracking-widest px-2 mb-1 mt-2"
